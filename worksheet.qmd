...
#str_view(energy_sources, "S.+") #[1] │ <Solar (MWh)>
#str_view(energy_sources, "\\(MWh\\)")
#str_extract(energy_sources, "S.+") #returns a vector 

str_view(energy_sources, "[A-Z].* ")
str_extract(energy_sources, "[A-Z].* ")
```
